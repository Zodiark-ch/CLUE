...
class DataCollatorIOI:
    ...
    def __call__(self, examples):
        ...
        for example in examples:
            ...
            # Safely find first padding position
...
def main():
    ...
    print(f"All parameters of mistral_model are frozen, trainable parameter count: {mistral_trainable_params}")
    ...
    # Compare parameter states of two models
    print("\n=== Model Parameter State Comparison ===")
