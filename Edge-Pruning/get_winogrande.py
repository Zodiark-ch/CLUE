...
def save_dataset_to_disk(
    ...
    try:
        ...
        print(f"Error occurred while saving dataset: {e}")
        raise
...
def load_dataset_from_disk(
    ...
    try:
        ...
        print(f"Successfully loaded dataset from local, contains {len(dataset)} samples")
        print(f"Dataset features: {dataset.features}")
        
        return dataset
        
    except Exception as e:
        print(f"Error occurred while loading dataset from local: {e}")
        raise
